$(document).ready(function () {
  ...
  var sidebarData = [
    {
      link: userProfile.appUrl+"/receptionist/dashboard.php",
      iconClass: "fa-solid fa-chart-pie",
      label: "Dashboard",
    },
    {
      link: userProfile.appUrl+"/receptionist/patients.php",
      iconClass: "fa-solid fa-user-injured",
      label: "Patients",
      sublink: ["/receptionist/add-patient.php","/receptionist/edit-patient.php","/receptionist/view-patient.php"],
    },
    {
      link: userProfile.appUrl+"/receptionist/appointments.php",
      iconClass: "fa-solid fa-calendar-check",
      label: "Appointments",
      sublink: ["/receptionist/add-appointment.php"],
    }
  ];
