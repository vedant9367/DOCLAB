                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="d-flex mt-5">
                                <div><button class="btn btn-outline-secondary me-3" name="btnProfile">Save</button></div><a class="btn btn-secondary me-3" href="/receptionist/dashboard.php">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
