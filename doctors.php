  ...
  <div class="body-wrapper">
    ...
    <div class="p-5">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <h3>Doctors</h3>
        <a class="btn btn-outline-secondary" href="./add-doctor.php">New Doctor</a>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="viewUserLabel">View Doctor</h5>
...
<script>
  ...
  $('#dataTable').DataTable({
    ...
    "columns": [{
      ...
      {
        "render": function(data, type, full, meta) {
          return '<a href="./view-doctor.php?id=' + full.id + '" name="view" title="View Doctor" value="view" id="' + full.id + '" class="btn btn-warning mx-1 view_data"><span class="fa fa-eye"></span></a>' +
            '<a href="./edit-doctor.php?id=' + full.id + '" name="edit" title="Edit Doctor" value="Edit" id="' + full.id + '" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></a>' +
  ...
  $(document).ready(function() {
    $(document).on('change', '.status_change', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response == 1) {
            toastr.success("Doctor status updated successfully");
          } else {
            toastr.error(response);
          }
        },
