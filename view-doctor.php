...
if (isset($_GET['id'])) {
  ...
  if ($result && $result->num_rows > 0) {
    ...
    $department_id = $row['diagnosis_id'];

    // Fetch diagnosis details
    $diagnosis_query = "SELECT diagnosis_name FROM diagnosis WHERE id = $department_id";
    $department_result = mysqli_query($connection, $diagnosis_query);
    $diagnosis_name = ($department_result && $department_result->num_rows > 0) ? $department_result->fetch_assoc()['diagnosis_name'] : "N/A";
              ...
              <div class="table-responsive">
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      <td class="py-4 fw-bold">Diagnosis Name:</td>
                      <td class="py-4"><?php echo $diagnosis_name; ?></td>
                    </tr>
                    <tr>
